...
# 02/05/15   abirudur  Added support for LE [msm8936]
#===============================================================================
...
class TZ_BSP_Dump() :       
    ...
    def processDiagData(self,offset) :        
        try:            
            ...
            #   RING BUFF CONTENTS
            # ==================
            # Get the length from diag itself
