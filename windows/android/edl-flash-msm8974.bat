...
%BUSYBOX_EXE% sleep 5
%EMMCDL_EXE% -p %COM_NUMBER% -f %~dp0\qcom\prog_emmc_firehose_8974.mbn -x rawprogram_unsparse.xml
%BUSYBOX_EXE% sleep 5
%EMMCDL_EXE% -p %COM_NUMBER% -f %~dp0\qcom\prog_emmc_firehose_8974.mbn -x patch0.xml
%BUSYBOX_EXE% sleep 3
